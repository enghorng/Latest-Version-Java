                        ...
                        if(k<z){
                            if(clsCon.getRs().getString("Day").equals("Monday")){
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session1")&&txtMonday1.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day1+"' and SesionID = '"+lblSession1.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session2")&&txtMonday2.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day1+"' and SesionID = '"+lblSession2.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                            ...
                            if(clsCon.getRs().getString("Day").equals("Tuesday")){
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session1")&&txtTuesday1.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day2+"' and SesionID = '"+lblSession1.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session2")&&txtTuesday2.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day2+"' and SesionID = '"+lblSession2.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                            ...
                            if(clsCon.getRs().getString("Day").equals("Wednesday")){
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session1")&&txtWednesday1.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day3+"' and SesionID = '"+lblSession1.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session2")&&txtWednesday2.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day3+"' and SesionID = '"+lblSession2.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                            ...
                            if(clsCon.getRs().getString("Day").equals("Thursday")){
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session1")&&txtThursday1.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day4+"' and SesionID = '"+lblSession1.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session2")&&txtThursday2.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day4+"' and SesionID = '"+lblSession2.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                            ...
                            if(clsCon.getRs().getString("Day").equals("Friday")){
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session1")&&txtFriday1.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day5+"' and SesionID = '"+lblSession1.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session2")&&txtFriday2.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day5+"' and SesionID = '"+lblSession2.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                            ...
                            if(clsCon.getRs().getString("Day").equals("Saturday")){
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session1")&&txtSaturday1.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day6+"' and SesionID = '"+lblSession1.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
                                ...
                                if(clsCon.getRs().getString("SessionName").equals("Session2")&&txtSaturday2.getText().equals("")){
                                    ...
                                    Update("update tblTimetable set Active  = 1 where CourseID = "+lblCourse.getText()+" and SemesterID = '"+lblSemester.getText()+"' and ClassID = '"+lblClass.getText()+"' and TeacherID = '"+lblTeacher.getText()+"' and ShiftID = '"+shift+"' and DayID = '"+Day6+"' and SesionID = '"+lblSession2.getText()+"' and RoomID = '"+lblRoomID.getText()+"'");
